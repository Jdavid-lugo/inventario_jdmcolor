@extends('layouts.app', ['page' => 'Nuevo metodo de pago', 'pageSlug' => 'methods-create', 'section' => 'transactions'])
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Nuevo metodo de pago</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('methods.index') }}" class="btn btn-sm btn-primary">Volver a la lista</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('methods.store') }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">Información del metodo de pago</h6>
                            <div class="pl-lg-4">
