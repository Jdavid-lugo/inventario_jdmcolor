@extends('layouts.app', ['page' => 'Proveedores', 'pageSlug' => 'providers', 'section' => 'providers'])
                                ...
                                @foreach ($providers as $provider)
                                    <tr>
                                        ...
                                        <td class="td-actions text-right">
                                            <a href="{{ route('providers.show', $provider) }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="Mas detalles">
                                            ...
                                            <form action="{{ route('providers.destroy', $provider) }}" method="post" class="d-inline">
                                                @csrf
                                                @method('delete')
                                                <button type="button" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="Eliminar Proveedor" onclick="confirm('Desea eliminar proveedor?.') ? this.parentElement.submit() : ''">
