                        ...
                        <form method="post" action="{{ route('products.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="description" id="input-description" class="form-control form-control-alternative" placeholder="Descripción" value="{{ old('description') }}" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">                                    
                                        <div class="form-group{{ $errors->has('stock_defective') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" name="stock_defective" id="input-stock_defective" class="form-control form-control-alternative" placeholder="Stock Defectuoso" value="{{ old('stock_defective') }}" required>
                                    ...
                                    <div class="col-4">                                    
                                        <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" step=".01" name="price" id="input-price" class="form-control form-control-alternative" placeholder="Precio" value="{{ old('price') }}" required>
